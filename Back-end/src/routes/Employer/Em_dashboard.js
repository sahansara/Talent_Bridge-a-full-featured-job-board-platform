...
//       role: user.role,  
//       employerImage: user.image ? user.image : null,
//     };
...
router.get('/jobs', async (req, res) => {
  try {
    ...
    // Find all jobs associated with the employer ID from the token
...
router.put('/jobs/:id', jobThumbnailUpload.single('thumbnail'), async (req, res) => {
  try {
    ...
    // Find job by ID and employer ID to ensure ownership
